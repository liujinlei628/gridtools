...
public class BusinessDatas extends CRUD {

    /**
     * 跳转到信息查看页面
     * @param id 
     */
    public static void list(int startPosition, String content, String tableName) {
        ...
        if(tableName !=null && !"".equals(tableName)){
            query += " AND business ='" + tableName + "'" ;
        }
        
        query += " GROUP BY bus_table_name ORDER BY ID" ;
        
        Logger.info(query);
        
        List<TCfgBusinessData> list =TCfgBusinessData.find(query).from(startPosition*10).fetch(10);
        ...
        render(startPosition, totalReport, list, dictList, content, tableName);
    ...
    public static void previousPage(int startPosition, int totalReport, String content, String tableName) {  
        ...
        list(startPosition, content, tableName);
    }  
     ...
     * @param content 内容
     */
    public static void nextPage(int startPosition, int totalReport, String content, String tableName) {  
